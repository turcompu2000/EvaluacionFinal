  ...
  <body>
    <x-app-layout>
      ...
      <div class="py-12">
        ...
        <label for="Carreras">Carreras Profesionales</label>
        <select class="form-select" id="Carreras" name="Carreras" required>
           ...
           <a href="{[route('Registro.index')]}" class="btn btn-warning">Volver</a>
            </div>
          </form>
    </div>
  </div>
